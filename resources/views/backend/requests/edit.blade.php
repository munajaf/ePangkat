...
@section('content')
    <form method="post" action="{{route('admin.request.update', $id)}}" id="form">
        @csrf
        @method('patch')
        <div class="row mb-4">
            <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            ...
                            <div class="row pb-5 form-group">
                                <div class="row col-md-10">
                                    <div class="form-group col-xs-10 col-sm-10 col-md-4 col-lg-4">
                                        ...
                                        <a class="btn btn-primary btn-block" href="/{{$data->kategori1_syarat1[0]}}" target="_blank">Attachment</a>
                                    </div>
                                    <div class="form-group col-xs-10 col-sm-10 col-md-4 col-lg-4">
                                        <label>Tahun 2</label>
                                        <a class="btn btn-primary btn-block" href="/{{$data->kategori1_syarat1[1]}}" target="_blank">Attachment</a>
                                    </div>
                                    <div class="form-group col-xs-10 col-sm-10 col-md-4 col-lg-4">
                                        <label>Tahun 3</label>
                                        <a class="btn btn-primary btn-block" href="/{{$data->kategori1_syarat1[2]}}" target="_blank">Attachment</a>
                                    </div>
                                </div>
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label>Markah</label>
                                    <input value="{{$data->requestMarks->kategori1_syarat1}}" type="number" min="0" max="10" class="form-control" name="kategori1_syarat1" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori1_syarat2}}" type="number" min="0" max="20" class="form-control" name="kategori1_syarat2" />
                                </div>
                            </div>
                                ...
                                <div class="row col-md-10" id="kategori2_syarat1_wrapper">
                                        <div class="form-group col-xs-10 col-sm-10 col-md-6 col-lg-6">
                                            ...
                                            @foreach($data->kategori1_syarat3[0] as $key => $list)
                                                @if($i == 1)
                                                    <label>Bilangan MOOC / E-Learning</label><br />
                                                @endif
                                                <a class="btn btn-primary btn-block" href="/{{$list}}" target="_blank">Attachment {{$i++}}</a>
                                            @endforeach
                                        </div>
                                </div>
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori1_syarat3}}" type="number" min="0" max="5" class="form-control" name="kategori1_syarat3" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label>Markah</label>
                                    <input value="{{$data->requestMarks->kategori1_syarat4}}" type="number" min="0" max="5" class="form-control" name="kategori1_syarat4" />
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori2_syarat1}}" type="number" min="0" max="5" class="form-control" name="kategori2_syarat1" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori2_syarat2}}" type="number" min="0" max="5" class="form-control" name="kategori2_syarat2" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori2_syarat3}}" type="number" min="0" max="5" class="form-control" name="kategori2_syarat3" />
                                </div>
                            </div>
                                ...
                                <div class="row col-md-10" id="kategori2_syarat4_wrapper">
                                    @foreach($data->kategori2_syarat4 as $key => $list)
                                        <div class="form-group col-xs-10 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            @endif
                                            <input type="text" class="form-control" id="" value="{{$list['jenis_penerbitan']}}" disabled>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori2_syarat4}}" type="number" min="0" max="5" class="form-control" name="kategori2_syarat4" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori2_syarat5}}" type="number" min="0" max="5" class="form-control" name="kategori2_syarat5" />
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori3_syarat1}}" type="number" min="0" max="5" class="form-control" name="kategori3_syarat1" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori3_syarat2}}" type="number" min="0" max="5" class="form-control" name="kategori3_syarat2" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori4_syarat1}}" type="number" min="0" max="5" class="form-control" name="kategori4_syarat1" />
                                </div>
                            </div>
                            ...
                            <div class="row pb-5">
                                ...
                                <div class="form-group col-xs-10 col-sm-10 col-md-2 col-lg-2">
                                    <label for="">Markah</label>
                                    <input value="{{$data->requestMarks->kategori4_syarat2}}" type="number" min="0" max="5" class="form-control" name="kategori4_syarat2" />
                                </div>
                            </div>
                            <div class="row col-md-12">
                                <input type="text" name="status" value="accepted" hidden id="status">
                                <div class="col-md-6 form-group">
                                    <button id="approve" type="submit" class="btn btn-success btn-block">Approve / Submit</button>
                                </div>
                                <div class="col-md-6 form-group">
                                    <button id="reject_button" type="submit" class="btn btn-danger btn-block" name="reject" value="true">Reject</button>
                                </div>
                            </div>
