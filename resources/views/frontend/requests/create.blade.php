            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(!isset(request()->page))
                        @include('frontend.requests.kategori')
                    @endif
                    @if(request()->page == 1)
                        @include('frontend.requests.kategori1')
                    @endif
                    @if(request()->page == 2)
                        @include('frontend.requests.kategori2')
                    @endif

                    @if(request()->page == 3)
                        @include('frontend.requests.kategori3')
                    @endif

                    @if(request()->page == 4)
                        @include('frontend.requests.kategori4')
                    @endif
