                ...
                <div class="col-md-12">
                    ...
                    @foreach($data->kategori1_syarat2[0] as $key => $list)
                        <div class="row col-md-12 row">
                            <div class="row col-md-11 mb-2">
                                <input class="form-control-file" name="kategori1_syarat2_1[attach][]" value="{{$list['attach']}}" hidden/>
        ...
        @foreach($data->kategori1_syarat2[1] as $key => $list)
            <div class="col-md-12 row mb-2">
                <div class="col-md-11 row">
                    <input class="form-control-file" name="kategori1_syarat2_2[attach][]" value="{{$list['attach']}}" hidden/>
                    <a class="btn btn-primary btn-block" href="/{{$list['attach']}}" target="_blank">Attachment {{$key + 1}}</a>
                </div>
        ...
        @foreach($data->kategori1_syarat2[2] as $key => $list)
            <div class="col-md-12 row mb-2">
                <div class="row col-md-11 row">
                    <input class="form-control-file" name="kategori1_syarat2_3[attach][]" value="{{$list['attach']}}" hidden/>
                    <a class="btn btn-primary btn-block" href="/{{$list['attach']}}" target="_blank">Attachment {{$key + 1}}</a>
                </div>
                <div class="col-md-1 row ml-0">
                    <button class="btn btn-danger btn-sm" style="margin-top: 2px" onclick="deleteFields(event, this)"><i class="fas fa-trash-alt"></i></button>
                        ...
                        @foreach($data->kategori1_syarat3[0] as $key => $list)
                            <div class="row col-md-12 mb-2">
                                <div class="col-md-3 row">
                                    <input class="form-control-file" name="kategori1_syarat3_1[attach][]" value="{{$list}}" hidden/>
                ...
                <div id="kategori1_syarat4_1_wrapper">
                    <div id="kategori1_syarat4_1">
                        @foreach($data->kategori1_syarat4[0] as $key => $list)
                            <div class="row col-md-12 mb-2">
                                <div class="col-md-11 row">
                                    <input class="form-control-file" name="kategori1_syarat4_1[attach][]" value="{{$list['attach']}}" hidden/>
                                    <a class="btn btn-primary btn-block" href="/{{$list['attach']}}" target="_blank">Attachment {{$key + 1}}</a>
                                </div>
                                <div class="col-md-1 row ml-0">
                                    <button class="btn btn-danger btn-sm" style="margin-top: 2px" onclick="deleteFields(event, this)"><i class="fas fa-trash-alt"></i></button>
                ...
                <div id="kategori1_syarat4_2_wrapper">
                    <div id="kategori1_syarat4_2">
                        @foreach($data->kategori1_syarat4[1] as $key => $list)
                            <div class="row col-md-12 mb-2">
                                <div class="col-md-11 row">
                                    <input class="form-control-file" name="kategori1_syarat4_2[attach][]" value="{{$list['attach']}}" hidden/>
                                    <a class="btn btn-primary btn-block" href="/{{$list['attach']}}" target="_blank">Attachment {{$key + 1}}</a>
                                </div>
                                <div class="col-md-1 row ml-0">
                                    <button class="btn btn-danger btn-sm" style="margin-top: 2px" onclick="deleteFields(event, this)"><i class="fas fa-trash-alt"></i></button>
