...
<div class="row pb-5">
    <div class="row col-md-11" id="kategori2_syarat3_wrapper">
        <div class="form-group col-xs-10 col-sm-3 col-md-6 col-lg-6">
            ...
            <input type="text" class="form-control" name="kategori2_syarat3[jumlah_geran][0]"
        ...
        <div class="form-group col-xs-10 col-sm-3 col-md-6 col-lg-5">
            <label>Attachment</label>
            <input class="form-control-file" name="kategori2_syarat3[attach][0]"
        ...
        <div class="form-group col-xs-10 col-sm-3 col-md-6 col-lg-6">
            ...
            <input type="text" class="form-control" name="kategori2_syarat3[jumlah_geran][1]"
        ...
        <div class="form-group col-xs-10 col-sm-3 col-md-6 col-lg-5">
            <label>Attachment</label>
            <input class="form-control-file" name="kategori2_syarat3[attach][1]"
